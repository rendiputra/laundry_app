...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card shadow">
            <form method="POST" action="{{route('createPelangganAction')}}" enctype="multipart/form-data">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <label>Nama</label>
                <input type="text" name="nama" class="form-control" value="" required="" placeholder="Contoh: Rendi Putra">
                </div>
                <div class="form-group">
                <label>Alamat</label>
                ...
                <input type="number" name="notelp" class="form-control" value="" required="" placeholder="Contoh: 085600121789">
                </div>
